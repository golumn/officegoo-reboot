	...
	class ExportController {
		...
		function generateBook($book, $format) {
			...
			if ($format!= "ods"){
				...
				$this->objPHPExcel->getProperties()->setCreator("GelSheet Team");
				$this->objPHPExcel->getProperties()->setLastModifiedBy("GelSheet Team");
				$this->objPHPExcel->getProperties()->setTitle("Document");
				$this->objPHPExcel->getProperties()->setSubject("Document");
				$this->objPHPExcel->getProperties()->setDescription("Document generated using GelSheet.");
				$this->objPHPExcel->getProperties()->setKeywords("office GelSheet php");
				$this->objPHPExcel->getProperties()->setCategory("GelSheet");
